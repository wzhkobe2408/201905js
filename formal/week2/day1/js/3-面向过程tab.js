// 1. 获取元素
// 1.1 获取容器元素
let wrapper = document.querySelector('#tab1');
// 1.2 获取选项卡头
let headerList = wrapper.querySelectorAll('.header > li');
// 1.3 获取所有的卡片
let cardList = wrapper.querySelectorAll('div');
...
for (let i = 0; i < headerList.length; i++) {
  ...
  headerList[i].onclick = function () {
    ...
    for (let j = 0; j < headerList.length; j++) {
      headerList[j].className = ''; // 清选项卡头的active样式
...
// 1. 获取元素
// 1.1 获取容器元素
let wrapper1 = document.querySelector('#tab2');
// 1.2 获取选项卡头
let headerList1 = wrapper1.querySelectorAll('.header > li');
// 1.3 获取所有的卡片
let cardList1 = wrapper1.querySelectorAll('div');
