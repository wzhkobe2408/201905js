...
// 5. 方法调用时，看方法名前面有没有点，有点的话，点前面是谁方法中的this就是谁，如果没有点，方法中的this就是window
...
let sum2 = sum.bind(obj, 1, 2); // 传参的时候和call一样，需要一个一个的传
console.log(sum2);
console.log(sum === sum2); // false 因为sum2是一个新函数
sum2(); // 修改this后，需要自己执行一次这个函数

// call和apply是修改this并且让函数执行，call是一个一个的传参，apply传递一个数组
