...
let reg = /^1\d{10}$/;
// console.log(reg.test('19901046931'));
// console.log(reg.test('16601046931'));
...
// console.log(reg3.test('17723347666'));

// 4. 匹配靓号：中间四位相同末尾四位相同
let reg4 = /^1\d{2}(\d)\1{3}(\d)\2{3}$/;
// console.log(reg4.test('13077778888'));
...
// 2）如果是个位数，0-9的任意一个数字
// 3）如果是多位数0不能作为开头
// 4）小数点可以有，可以没有，如果有，后面至少有一位小数
let reg5 = /^[+-]?(\d|[1-9]\d+)(\.\d+)?$/;
// console.log(reg5.test('.5')); // false
// console.log(reg5.test('1.5')); // true
// console.log(reg5.test('9')); // true
// console.log(reg5.test('99')); // true
// console.log(reg5.test('99.99')); // true
// console.log(reg5.test('99.')); // false
// console.log(reg5.test('099')); // false
...
// console.log(reg7.test('裴泽惠')); // true
// console.log(reg7.test('郭达斯坦森')); // true
