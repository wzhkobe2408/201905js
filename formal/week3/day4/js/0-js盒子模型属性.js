...
// offsetParent 距离当前元素最近的有定位属性的父级元素，如果所有父级元素都没有的话就是body元素；
...
let winClientTop = document.documentElement.clientTop || document.body.clientTop;
