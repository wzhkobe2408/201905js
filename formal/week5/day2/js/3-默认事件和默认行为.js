// 例如页面中的a标签，我们不需要做额外的处理，点击a标签就可以跳转到href指向的链接。这种行为称为元素的默认行为，类似的还有鼠标右键点击出现一个菜单；

// 我们也没有给a标签绑定过事件，但是点击它却有反应，这种事件时默认的。
...
// 我们发现a标签被点击时照样会跳走，而且 '123344' 会输出出来。说明它默认行为还在，我们绑的事件也生效；
