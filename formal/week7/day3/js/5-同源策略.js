...
// http://localhost:5500 和 file://C://js/teacher/index.html (协议不同，file:// file协议)

// localhost:63342 和 localhost:5500 （端口号不同）
...
// 4. CORS: Cross-Origin-Resource-Sharing 跨域资源共享；需要目标源设置Access-Control-Allow-Origin响应头；

// AJAX 虽然好用，但是不能跨域；如果一定要跨域就需要做特殊处理；
