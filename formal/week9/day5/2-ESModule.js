...
// import {name as name1} from './a.js'; // 导入的时候重命名

import * as obj from './a.js'; // 全部导入，此时obj是一个对象，对象中包含了所有a模块导出的内容；导出的变量名都成为了obj的属性名；
...
// 5. import() 方法，
// import是关键字只能用在同步导出，而且必须置于全局作用域中（不能写在函数或者if中）
